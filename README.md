...
# ECE-2112-PA-4
**Submitted by: ZECHARIAH SAMPANG | 2ECE-C**
...
1. Among the Track categories, **Communication** has the highest mean Average (67.97).
2. Among the Gender categories, **Male** has the highest mean Average (67.18).
